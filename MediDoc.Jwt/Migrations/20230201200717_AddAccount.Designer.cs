...
namespace MediDoc.Migrations
{
    ...
    [Migration("20230201200717_AddAccount")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MediDoc.Jwt.Models.Account", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Email = "admin@test.pl",
                            Password = "ndxgnElkATrfOjvq2SeRND7YC7pUSbY6rfrOrAB2THw=",
                            Salt = "IxbjSpewtO++d0NkUgAzCQ==",
                            Username = "Admin"
                        });
                });

            modelBuilder.Entity("MediDoc.Jwt.Models.Doctor", b =>
                {
            ...
            modelBuilder.Entity("MediDoc.Jwt.Models.Medicament", b =>
                {
            ...
            modelBuilder.Entity("MediDoc.Jwt.Models.Patient", b =>
                {
            ...
            modelBuilder.Entity("MediDoc.Jwt.Models.Prescription", b =>
                {
            ...
            modelBuilder.Entity("MediDoc.Jwt.Models.PrescriptionMedicament", b =>
                {
                    b.Property<int>("IdMedicament")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MediDoc.Jwt.Models.Prescription", b =>
                {
                    b.HasOne("MediDoc.Jwt.Models.Doctor", "IdDoctorNavigation")
                        .WithMany("Prescriptions")
                        .HasForeignKey("IdDoctor")
                        .IsRequired()
                        .HasConstraintName("Prescription_Doctor");

                    b.HasOne("MediDoc.Jwt.Models.Patient", "IdPatientNavigation")
                        .WithMany("Prescriptions")
            ...
            modelBuilder.Entity("MediDoc.Jwt.Models.PrescriptionMedicament", b =>
                {
                    b.HasOne("MediDoc.Jwt.Models.Medicament", "IdMedicamentNavigation")
                        .WithMany("PrescriptionMedicaments")
                        .HasForeignKey("IdMedicament")
                        .IsRequired()
                        .HasConstraintName("Prescription_Medicament_Medicament");

                    b.HasOne("MediDoc.Jwt.Models.Prescription", "IdPrescriptionNavigation")
                        .WithMany("PrescriptionMedicaments")
